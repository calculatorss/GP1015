...
awk '{print $1, $2, $3}' $input_gmt | gmt psxy -R -J -Sc0.05 -O -K >> $out_ps
echo 122.00 26.70 22,1,black 0 CM Taiwan Earthquake History Distribution Map | gmt pstext -R -J -F+f+a+j -N -O -K >> $out_ps
