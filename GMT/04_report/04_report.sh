...
awk '{if ($4>=4 && $4<5) print $1, $2, $3}' $input_list | gmt psxy -R -J -Sc0.1 -C$cpt -O -K >> $out_ps
awk '{if ($4>=5 && $4<6) print $1, $2, $3}' $input_list | gmt psxy -R -J -Sc0.2 -C$cpt -O -K >> $out_ps
awk '{if ($4>=6 && $4<7) print $1, $2, $3}' $input_list | gmt psxy -R -J -Sc0.3 -C$cpt -O -K >> $out_ps
...
awk '{if ($4>=4 && $4<5) print $1, $3, $3}' $input_list | gmt psxy -R -J -Sc0.1 -C$cpt -O -K >> $out_ps
awk '{if ($4>=5 && $4<6) print $1, $3, $3}' $input_list | gmt psxy -R -J -Sc0.2 -C$cpt -O -K >> $out_ps
awk '{if ($4>=6 && $4<7) print $1, $3, $3}' $input_list | gmt psxy -R -J -Sc0.3 -C$cpt -O -K >> $out_ps
...
awk '{if ($4>=4 && $4<5) print $3, $2, $3}' $input_list | gmt psxy -R -J -Sc0.1 -C$cpt -O -K >> $out_ps
awk '{if ($4>=5 && $4<6) print $3, $2, $3}' $input_list | gmt psxy -R -J -Sc0.2 -C$cpt -O -K >> $out_ps
awk '{if ($4>=6 && $4<7) print $3, $2, $3}' $input_list | gmt psxy -R -J -Sc0.3 -C$cpt -O -K >> $out_ps
